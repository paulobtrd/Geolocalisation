...
#ajouts paul bertrand =======================================================================================================================

# Mesures approximatives de la salle polyvalente en mètres
salle_points_m = [
    (3.0, 2.0),   # bas gauche
    (18.5, 3.0),  # bas droit
    (17.5, 11.0), # haut droit
    (4.0, 11.5)   # haut gauche
]


def draw_room_polygon(t, points_m, scale=20):
...
def meters_to_pixels(x_m, y_m, scale=20):
    # Origine au centre de la salle
    x_centered = (x_m - 19.5 / 2) * scale
    y_centered = (y_m - 12.5 / 2) * scale
    return x_centered, y_centered

#fin modif paul bertrand==================================================================================================================
...
def main():
    ...
    draw_ui(t_ui)
    draw_room_polygon(t_ui, salle_points_m, meter2pixel)
